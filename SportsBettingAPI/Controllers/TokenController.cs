...
namespace SportsBettingAPI.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        public TokenController(IConfiguration config, ISportsBettingRepository repository)
        {
        ...
        public async Task<IActionResult> Post(UserInfo _userData)
        {
            ...
            {
                var user = await _repository.GetUserAsync(_userData.Email, _userData.Password);
